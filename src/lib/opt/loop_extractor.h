...
struct LoopExtractor2Pass : public PassInfoMixin<LoopExtractor2Pass> {
  LoopExtractor2Pass(unsigned NumLoops = ~0) : NumLoops(NumLoops) {}
...
#endif // LLVM_TRANSFORMS_IPO_LOOPEXTRACTOR2_H