...
; CHECK: loop_body:
; CHECK-NEXT:   %cur_i_val = add i32 1, %cur_i
; CHECK-NEXT:   %cur_sum_val = add i32 %cur_sum, %cur_i_val
; CHECK-NEXT:   store i32 %cur_sum_val, i32* %sum, align 4
; CHECK-NEXT:   %next_i = add i32 %cur_i, 1
...
; CHECK: loop_body.1:
; CHECK-NEXT:   %cur_i_val.1 = add i32 1, %cur_i.1
; CHECK-NEXT:   %cur_sum_val.1 = add i32 %cur_sum.1, %cur_i_val.1
; CHECK-NEXT:   store i32 %cur_sum_val.1, i32* %sum, align 4
; CHECK-NEXT:   %next_i.1 = add i32 %cur_i.1, 1
...
; CHECK: loop_body.2:
; CHECK-NEXT:   %cur_i_val.2 = add i32 1, %cur_i.2
; CHECK-NEXT:   %cur_sum_val.2 = add i32 %cur_sum.2, %cur_i_val.2
; CHECK-NEXT:   store i32 %cur_sum_val.2, i32* %sum, align 4
; CHECK-NEXT:   %next_i.2 = add i32 %cur_i.2, 1
...
; CHECK: loop_body.3:
; CHECK-NEXT:   %cur_i_val.3 = add i32 1, %cur_i.3
; CHECK-NEXT:   %cur_sum_val.3 = add i32 %cur_sum.3, %cur_i_val.3
; CHECK-NEXT:   store i32 %cur_sum_val.3, i32* %sum, align 4
; CHECK-NEXT:   %next_i.3 = add i32 %cur_i.3, 1
...
; CHECK: loop_body.4:
; CHECK-NEXT:   %cur_i_val.4 = add i32 1, %cur_i.4
; CHECK-NEXT:   %cur_sum_val.4 = add i32 %cur_sum.4, %cur_i_val.4
; CHECK-NEXT:   store i32 %cur_sum_val.4, i32* %sum, align 4
; CHECK-NEXT:   %next_i.4 = add i32 %cur_i.4, 1
...
; CHECK: loop_body.5:
; CHECK-NEXT:   %cur_i_val.5 = add i32 1, %cur_i.5
; CHECK-NEXT:   %cur_sum_val.5 = add i32 %cur_sum.5, %cur_i_val.5
; CHECK-NEXT:   store i32 %cur_sum_val.5, i32* %sum, align 4
; CHECK-NEXT:   %next_i.5 = add i32 %cur_i.5, 1
...
; CHECK: loop_body.6:
; CHECK-NEXT:   %cur_i_val.6 = add i32 1, %cur_i.6
; CHECK-NEXT:   %cur_sum_val.6 = add i32 %cur_sum.6, %cur_i_val.6
; CHECK-NEXT:   store i32 %cur_sum_val.6, i32* %sum, align 4
; CHECK-NEXT:   %next_i.6 = add i32 %cur_i.6, 1
...
; CHECK: loop_body.7:
; CHECK-NEXT:   %cur_i_val.7 = add i32 1, %cur_i.7
; CHECK-NEXT:   %cur_sum_val.7 = add i32 %cur_sum.7, %cur_i_val.7
; CHECK-NEXT:   store i32 %cur_sum_val.7, i32* %sum, align 4
; CHECK-NEXT:   %next_i.7 = add i32 %cur_i.7, 1
