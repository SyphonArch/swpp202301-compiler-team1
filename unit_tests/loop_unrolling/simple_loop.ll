...
; CHECK: latch.epil:                                       ; preds = %latch.epil, %latch.epil.preheader
; CHECK-NEXT:   %i3.epil = phi i32 [ %i3.unr, %latch.epil.preheader ], [ %next_i.epil, %latch.epil ]
; CHECK-NEXT:   %sum2.epil = phi i32 [ %sum2.unr, %latch.epil.preheader ], [ %next_sum.epil, %latch.epil ]
; CHECK-NEXT:   %epil.iter = phi i32 [ 0, %latch.epil.preheader ], [ %epil.iter.next, %latch.epil ]
...
; CHECK: loop.exit_crit_edge.epilog-lcssa:                 ; preds = %latch.epil
; CHECK-NEXT:   %split.ph4 = phi i32 [ %next_sum.epil, %latch.epil ]
