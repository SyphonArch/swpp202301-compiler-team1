...
; CHECK: latch.epil.1:                                     ; preds = %latch.epil
...
; CHECK: latch.epil.2:                                     ; preds = %latch.epil.1
...
; CHECK: latch.epil.3:                                     ; preds = %latch.epil.2
...
; CHECK: latch.epil.4:                                     ; preds = %latch.epil.3
...
; CHECK: latch.epil.5:                                     ; preds = %latch.epil.4
...
; CHECK: latch.epil.6:                                     ; preds = %latch.epil.5
; CHECK-NEXT:   %next_sum.epil.6 = add i32 %next_sum.epil.5, %next_i.epil.5
; CHECK-NEXT:   br label %loop.exit_crit_edge.epilog-lcssa
; CHECK: loop.exit_crit_edge.epilog-lcssa:                 ; preds = %latch.epil.6, %latch.epil.5, %latch.epil.4, %latch.epil.3, %latch.epil.2, %latch.epil.1, %latch.epil
; CHECK-NEXT:   %split.ph4 = phi i32 [ %next_sum.epil, %latch.epil ], [ %next_sum.epil.1, %latch.epil.1 ], [ %next_sum.epil.2, %latch.epil.2 ], [ %next_sum.epil.3, %latch.epil.3 ], [ %next_sum.epil.4, %latch.epil.4 ], [ %next_sum.epil.5, %latch.epil.5 ], [ %next_sum.epil.6, %latch.epil.6 ]
